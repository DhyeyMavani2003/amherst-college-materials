...
> ANSWER: (is the relationship linear? how strong is the association?)
...
19. Check the regression conditions. Do you see any problems?
...
20. Assuming there are no serious problems with the conditions, does the ANOVA (F) test suggest the regression model is useful for predicting volume?

> ANSWER:

21. Which individual predictors are significant according to the output?
...
24. What would the regression equation be to predict volume on a day with low cloud cover and not a weekday? 

> ANSWER:

25. What would the regression equation be to predict volume on a day with medium cloud cover that is a weekday?

> ANSWER:

26. Interpret the R-squared for your model. How well does your model fit the data? 
