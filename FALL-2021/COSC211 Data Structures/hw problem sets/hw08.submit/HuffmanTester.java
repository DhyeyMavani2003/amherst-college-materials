...
public class HuffmanTester {
    ...
    public static final String SHAKESPEARE_PATH = "dhyey.txt";
	...
	// String path = METAMORPHOSES_PATH;
	...
	// int originalSize = huff.originalSize();
	// System.out.println("\nOriginal size: " + originalSize + " B");

	// int compressedSize = huff.compressedSize();
	// System.out.println("Compressed size: " + compressedSize + " B");
